...
export interface IColorState {
    ...
    _setUIElements(root: HTMLElement, palette: IPalette, sliders: ISliders, inputs: IInputs): void;
    _update(hsl: Partial<HSLA>, triggerColorEvent?: boolean, ignoreRGB?: boolean, updatePaletteAndSliders?: boolean): void;
    _setColor(color: Color, triggerColorEvent?: boolean, triggerChangeEvent?: boolean): void;
    _cache(): void;
    _change(): void;
}
...
export type EventListenerBinder = (target: EventTarget, type: string, listener: EventListenerOrEventListenerObject, options?: boolean | AddEventListenerOptions) => void;
...
export type LabeledElement = HTMLInputElement | HTMLSelectElement | HTMLButtonElement | ElementInternals | HTMLMeterElement | HTMLOutputElement | HTMLProgressElement | HTMLTextAreaElement;
export type HTMLElementHasDisabled = HTMLButtonElement | HTMLFieldSetElement | HTMLInputElement | HTMLSelectElement | HTMLOptionElement | HTMLTextAreaElement | HTMLOptGroupElement;
export {};
